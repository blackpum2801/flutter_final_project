...
import 'package:yoga_app/screens/splash/splash8.dart';
                  ...
                  SliderTheme(
                    data: SliderTheme.of(context).copyWith(
                      ...
                      overlayShape: RoundSliderOverlayShape(
                          overlayRadius: 30), // Đặt hình dạng của overlay
                      thumbShape: RoundSliderThumbShape(
                          enabledThumbRadius: 15), // Đặt hình dạng của thumb
                      thumbColor: Colors.purple, // Đặt màu sắc của thumb
                      activeTrackColor:
                          Colors.purple[100], // Đặt màu sắc của phần track
              ...
              child: ElevatedButton(
                onPressed: () {
                  ...
                  Navigator.push(
                    ...
                    MaterialPageRoute(
                        builder: (context) =>
                            splash8()), // Thay NextPage bằng tên trang tiếp theo của bạn
                  );
                },
