...
import 'package:yoga_app/models/age.dart';
import 'package:yoga_app/screens/splash/splash17.dart';
                  ...
                  child: ListWheelScrollView.useDelegate(
                    ...
                    childDelegate: ListWheelChildBuilderDelegate(
                      ...
                      builder: (context, index) {
                        final textColor = (_currentValue == index)
                            ? Colors.purple
                            : Colors.grey;
                        return MyAge(
                          age: index,
          ...
          Container(
            ...
            child: ElevatedButton(
              ...
              style: ElevatedButton.styleFrom(
                ...
                foregroundColor: Colors.white, // Màu chữ của nút là trắng
                minimumSize: Size(
                    MediaQuery.of(context).size.width * 0.8,
                    MediaQuery.of(context).size.height *
                        0.08), // Kích thước tối thiểu của nút
              ),
              child: Text(
                'Next',
